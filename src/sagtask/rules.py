...
DEFAULT_RULES: List[Dict[str, Any]] = [
    ...
    {
        "id": "rule-2",
        "content": "Simplicity first. Minimum code that solves the problem. No speculative design, no unrequested features.",
        "category": "thinking",
        "enabled": True,
    },
    {
        "id": "rule-3",
        "content": "Surgical changes. Touch only necessary code; don't refactor unrequested parts; match existing style.",
        "category": "process",
        "enabled": True,
    },
    {
        "id": "rule-4",
        "content": "Goal-driven. Define verification criteria and loop until met, don't follow rigid step sequences.",
        "category": "process",
        "enabled": True,
    },
    {
        "id": "rule-5",
        "content": "LLM for judgment only. Use LLM for classification, drafting, summarization, extraction. Use code for routing, retries, deterministic transforms.",
        "category": "quality",
        "enabled": True,
    },
    {
    ...
    {
        "id": "rule-7",
        "content": "Surface conflicts, don't average them. When patterns contradict, pick one and explain; flag the other for cleanup.",
        "category": "thinking",
        "enabled": True,
    },
    {
    ...
    {
        "id": "rule-9",
        "content": "Tests encode intent. Tests should encode why behavior matters, not just pass when business logic changes.",
        "category": "quality",
        "enabled": True,
    },
    {
        "id": "rule-10",
        "content": "Checkpoint every step. Summarize progress, verify state, list remaining work. Stop and restate position when lost.",
        "category": "process",
        "enabled": True,
    },
    {
        "id": "rule-11",
        "content": "Match codebase conventions. Consistency over personal preference. Raise disagreements explicitly, don't silently change style.",
        "category": "style",
        "enabled": True,
    },
    {
        "id": "rule-12",
        "content": "Fail loudly. Skipping tests and saying 'tests pass' is misleading. Surface uncertainty by default.",
        "category": "quality",
        "enabled": True,
    },
]
